import 'package:citycart/Page/Food/Foof_Restro_Cart.dart';
    ...
    return MaterialApp(
      home: Scaffold(
        body: Container(
          ...
          child: PaginatedCardView(), // Use PaginatedCardView inside the container
        ),
      ),
    );
  }
...
class PaginatedCardView extends StatefulWidget {
  @override
  _PaginatedCardViewState createState() => _PaginatedCardViewState();
}

class _PaginatedCardViewState extends State<PaginatedCardView> {
