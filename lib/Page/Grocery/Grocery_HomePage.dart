...
class _CityCartScreenState extends State<GroceryHomepage> {
  ...
  final List<String> bannerImages = [
    'assets/images/sabji.png', // Add your banner images here
    'assets/images/sabji.png',
    'assets/images/sabji.png',
    'assets/images/sabji.png',
  ];
                                      ...
                                      child: Stack(
                                        children: [
                                          ClipRRect(
                                            borderRadius: BorderRadius.circular(8.0), // Rounded corners
                                            child: Image.asset(
                                              'assets/images/medicineimg.png', // Replace with your image asset
                                              fit: BoxFit.cover,
