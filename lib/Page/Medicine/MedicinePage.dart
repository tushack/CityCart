...
import 'package:citycart/Page/Medicine/M_profile.dart';
import 'package:citycart/Page/Medicine/Medicine_Bottom_Navbar.dart';
import 'package:citycart/Page/Medicine/Medicine_Bottom_Navbar.dart';
import 'package:citycart/Page/Medicine/MedicinecartView.dart';
...
class _CityCartScreenState extends State<Medicinepage> {
                                      ...
                                      child: Stack(
                                        children: [
                                          ClipRRect(
                                            borderRadius: BorderRadius.circular(8.0), // Rounded corners
                                            child: Image.asset(
                                              'assets/images/medicineimg.jpg', // Replace with your image asset
                                              fit: BoxFit.cover,
                                              height: double.infinity,
                                              width: double.infinity,
                                            ),
                                          ),
                                          Padding(padding: const EdgeInsets.only(right: 94),
                                           //right: 78.0, // Adjust as needed
