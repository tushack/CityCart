...
class MedicineBottomNavbar extends StatefulWidget {
  const MedicineBottomNavbar({super.key});

  @override
  _BottomNavigationState createState() => _BottomNavigationState();
}

class _BottomNavigationState extends State<MedicineBottomNavbar> {
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Emptycart_M()),
      );
        break;
      case 2:
      // Navigator.push(
    ...
    return Transform(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Padding(
            padding: const EdgeInsets.only(left:6), // Horizontal padding inside the container
            child: Row(
                  ...
                  child: PopupMenuButton<String>(
                    ...
                    child: Row(
                     ...
                     SizedBox(width: 4,), // Gap between text and icon
                        Transform(
                          transform: Matrix4.identity()
                            ..translate(-6.0, 8.0, 0.0) // Adjust position
                            ..rotateZ(-0.8),
                          child: Icon(
                            Icons.arrow_forward,
                            color: Colors.white,
