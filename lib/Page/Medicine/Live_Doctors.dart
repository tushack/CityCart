...
class Live_Cart extends StatefulWidget {
  @override
  _ButtonRowState createState() => _ButtonRowState();
}

class _ButtonRowState extends State<Live_Cart> {
            ...
            children: [
              ...
              Positioned(
                ...
                child: Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center, // Center the Row's content horizontally
                    children: [
                      Text(
                        'Health Food',
                        style: TextStyle(
                      ...
                      SizedBox(width: 10), // Add some space between the text
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: 8.0, vertical: 4.0),
                        // decoration: BoxDecoration(
                        //   color: Colors.red, // Background color of the "Live" text
                    ...
                    child: Row(
                      ...
                      children: [
                        ColorFiltered(
                          ...
                          child: Image.asset(
                            'assets/images/soort.png', // Replace with your icon asset
                            width: 24.0,
                            height: 24.0,
                          ),
                        ),
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                                  'assets/images/image.png', // Replace with your product image
                                  width: 100.0,
                                  height: 100.0,
                                  fit: BoxFit.cover,
                                ),
