import 'package:citycart/Page/Medicine/Medicine_ItemViwer.dart';
    ...
    return MaterialApp(
      home: Scaffold(
        body: Container(
          ...
          child: Medicinecartview(), // Use PaginatedCardView inside the container
        ),
      ),
    );
  }
...
class Medicinecartview extends StatefulWidget {
  @override
  _PaginatedCardViewState createState() => _PaginatedCardViewState();
}

class _PaginatedCardViewState extends State<Medicinecartview> {
  ...
  void _navigateToNextPage() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MedicineItemviwer(), // Replace with your next page widget
      ),
    );
  }
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  'Sangay Clinic', // Replace with dynamic text if needed
                                  style: TextStyle(
                                    fontSize: 20.0,
